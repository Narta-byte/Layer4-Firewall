...
import Parallel_tree_algorithm.python.Trie_tree.ruleParser.ruleParser as ruleParser
import Parallel_tree_algorithm.python.Trie_tree.ruleParser.rule as ruleObject
